...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        onLoadError: function (data) {//全局新增表格请求错误处理
            if (data === 402) {
                landingTimeout(true);
            } else {
                if (typeof bootbox !== "undefined") {
                    bootbox.alert("error: code "+data);
                } else {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            ...
            '<ul class="pagination' + (this.options.iconSize === undefined ? '' : ' ' + this.options.iconSize) + '">',//Change by luo on 171229
