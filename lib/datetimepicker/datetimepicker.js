...
! function($) {
    ...
    var Datetimepicker = function(element, options) {
        ...
        this.clearBtn = (options.clearBtn || this.element.data('date-clear-btn') || false);// add by gyy
    ...
    Datetimepicker.prototype = {
        ...
        fill: function() {
            ...
            this.picker.find('tfoot th.clear')
                ...
                .toggle(this.clearBtn!==false); // add by gyy
            this.updateNavArrows();
            this.fillMonths();
    ...
    var DPGlobal = {
        ...
        footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'//add by gyy
    };
